<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ChuDeTheoDanhMuc.aspx.cs" Inherits="SANPHAM.ChuDeTheoDanhMuc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3 class="text-center ">DANH SÁCH SẢN PHẨM</h3>
    <asp:DataList ID="sanpham" runat="server" style="margin-right: 72px"  RepeatColumns="3">
        <ItemTemplate>
