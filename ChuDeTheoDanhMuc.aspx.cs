...
namespace SANPHAM
{
	public partial class ChuDeTheoDanhMuc : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			string machude = Request.QueryString["machude"] + "";
			if (machude != "")
			{
				string sql = "Select * From SANPHAM  Where MACHUDE=" + machude;
